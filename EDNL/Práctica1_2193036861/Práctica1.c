...
/**
 * @brief Crea un símbolo, el cual almacenará un char
 *
 * @param char val
 * @return Simbol*
 */
...
/**
 * @brief Crea un nodo, el cual almacenará un simbol
 *
 * @param pointer
 * @return Node*
 */
...
/**
 * @brief indica la jerarquía de los operadores de una expresión.
 *    
 * @param x
 * @return int
 */
...
/**
 * @brief Devuelve el caracter del último nodo almacenado en pila.
 * 
 * @param pila 
 * @return char 
 */
...
/*Ésta función "travel, o viaje en esp." es similar a pop, sin embargo ésta devuelve
...
int main() {
    ...
    char bufer[500]; //Cadena de carácteres que almacenará las lineas del archivo de lectura
    ...
    while (fgets(bufer, 500, archivo)){ 
        ...
        while (*e != '\0') { //e irá recorriendo toda la linea hasta encontrarse con un nulo.

            if (isalnum(*e)){ //isalnum permite saber si *e es un caracter alfanumérico.
        ...
        //este while nos permitirá imprimir lo último que está almacenado en la pila pues
    ...
    vaciar_Pila(pila); //vacía la pila


    //Éste es el ejercicio 2
