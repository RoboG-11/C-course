//Hacer un programa en C que cree un archivo de texto (.txt) llamado "hola mundo",
...
int main(){
	...
	char direccion[] = "C:\\Users\\river\\OneDrive\\Documents\\Curso de C\\Ejercicios de Archivos\\hola mundo.txt";
