/*
Ordenar numeros ascedentemente
*/
#include<stdio.h> //Libreria de entrada y salida

void ascendente(int a, int b, int c); //Declaracion de la funcion
...
int main(){ //Funcion principal
	...
	ascendente(a, b, c); //Se llama a la funcion
	
	return 0; //Se termina el programa
	
}

void ascendente(int a, int b, int c){ //Instrucciones de la funcion
